...
def print_report(files_info):
    ...
    print(f"{'Nome del file':<30}{'Dimensione Iniziale (MB)':<25}{'Dimensione Finale (MB)':<25}{'Rapporto di Compressione (%)'}")
    print("-" * 90)
    for file_info in files_info:
        filename, initial_size, final_size, compression_ratio = file_info
        print(f"{filename:<30}{initial_size / (1024 * 1024):<25.2f}{final_size / (1024 * 1024):<25.2f}{compression_ratio:<.2f}")
